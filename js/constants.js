...
export const MIND_RITUALS = [
  'One thing. Before the rest returns, place it here.',
  'Whatever else is open — it will wait. This is the only one.',
  'Gather what has scattered. It may take a moment.',
  'The thread you were following — before everything else arrived — find it.',
  'Slow down to one. The only speed that finds depth.',
  'Set aside what came before. There is room here for only one.',
  'Nothing else needs attention right now. This does.',
  'The rest will be there when you return.',
  'You do not need to finish everything. You only need to hold this one.',
  'The interruption has passed. You can return to depth now.',
  'One thing held carefully is worth more than many things held loosely.',
  'The scattering will return. But not yet. Not for this.',
  'Find the center of what you are doing. Then stay there.',
  'Let the other threads rest. They are not lost — they are waiting.',
  'This is the one surface you are on right now.',
  'Gather. Then begin.',
  'What you were doing before the last interruption — that.',
  'The mind wants to move. Let this be where it moves to.',
  'Bring the most important thing into one place. The rest can follow later.',
  'Depth is what happens when you stop moving between surfaces.',
  'One window. One thought. One direction.',
  'Whatever has been asking for attention — choose one. Set the others down.',
  'This is where the scattered parts can land.',
  'The noise is outside. In here, there is one thing.',
  'What was half-finished before? That can be the one.',
  'The mind is already moving toward something. Follow it to one place.',
  'This is the moment before depth begins. Use it to arrive.',
  'One held thing. That is enough.',
];
